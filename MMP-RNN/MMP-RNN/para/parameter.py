...
class Parameter:
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--threads', type=int, default=0, help='# of threads for dataloader')
        ...
        self.parser.add_argument('--mmp_weight', type=str, default='./model_best.pth.tar', help='the path of checkpoint file for mmp-net')

        # data parameters
        self.parser.add_argument('--data_root', type=str, default='../', help='the path of dataset')
        self.parser.add_argument('--dataset', type=str, default='gopro_lmdb', help='BSD, gopro_ds_lmdb, reds_lmdb')
        ...
        # model parameters
        self.parser.add_argument('--model', type=str, default='MMPRNN', help='type of model to construct')
        ...
        self.parser.add_argument('--n_blocks_a', type=int, default=7, help='# of blocks in middle part of the model')
        self.parser.add_argument('--n_blocks_b', type=int, default=8, help='# of blocks in middle part of the model')
        ...
        self.parser.add_argument('--do_skip', action='store_true', help='skip connection for current frame')
